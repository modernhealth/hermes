...
PERMANENT_SKIP_LIST = [
    ...
    # We don't support all CLDR values
    "test262/test/intl402/Intl/supportedValuesOf/calendars.js",
    "test262/test/intl402/Intl/supportedValuesOf/currencies-accepted-by-DisplayNames.js",
    # All of these tests use a full list of CLDR numbering systems
    "test262/test/intl402/Intl/supportedValuesOf/numberingSystems-accepted-by-",
    # All of these tests use a full list of CLDR calendars systems, we don't support Dangi
    "test262/test/intl402/Intl/supportedValuesOf/calendars-accepted-by-",
    # All of these tests use a full list of CLDR collations, we only return "standard"
    # currently.
    "test262/test/intl402/Intl/supportedValuesOf/collations-accepted-by-",
